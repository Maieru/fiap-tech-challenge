...
public static class ApplicationDependecyInjection
{
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        _ = services.AddScoped<ICriarOrdemServicoComClienteEVeiculoUseCase, CriarOrdemServicoComClienteEVeiculoUseCase>();
        _ = services.AddScoped<ICriarOrdemServicoCompletaUseCase, CriarOrdemServicoCompletaUseCase>();
        ...
        _ = services.AddScoped<IAprovarExecucaoOrdemServicoUseCase, AprovarExecucaoOrdemServicoUseCase>();
        _ = services.AddScoped<ICancelarOrdemServicoUseCase, CancelarOrdemServicoUseCase>();
        ...
        _ = services.AddScoped<IConsultarStatusOrdemServicoUseCase, ConsultarStatusOrdemServicoUseCase>();
